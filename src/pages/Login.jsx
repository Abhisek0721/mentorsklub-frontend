  ...
  return (
    <div className="border flex justify-center w-screen h-screen items-center bg-[var( --color-grey-50)]">
      <main className="my-6 mx-7">
        ...
        <form
          action=""
          className="rounded-sm min-w-[450px] bg-[var(--color-grey-100)] shadow-[var(--shadow-md)]">
          <div className="p-3 px-12 ">
            ...
            <div className="flex justify-center my-8 pb-5">
              <button className="w-full py-3 rounded-sm font-semibold bg-[var(--color-brand-500)] text-[var(--color-grey-0)]">
                Log in
              </button>
            </div>
          </div>
