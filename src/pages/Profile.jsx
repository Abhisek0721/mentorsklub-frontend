  ...
  return (
    <div className=" flex flex-col md:flex-row">
      ...
      <div className=" w-full p-6">
        ...
        <div>
          <ul className="flex flex-wrap gap-6">
            {skills.map((item, index) => (
              <li key={index} className="bg-slate-200 p-3 px-7 rounded-[20px] text-[14px] md:text-[18px]">{item}</li>
            ))}
          </ul>
        </div>
        ...
        <div className="py-8">
          <h1 className="py-4 font-semibold text-2xl md:text-4xl">My Strong Skill as a {userabout.Specialty}</h1>
