  ...
  const mentorPaths = [
    {
      id: 2,
      pathName: "Sessions",
      path: "/mentor/session", // mentor can create session and view his own upcoming sessions
      icon: <ClassOutlinedIcon fontSize="4xl" />,
    },
    {
      id: 3,
      pathName: "Subscription",
      path: "/mentor/subscription", // mentor can see all subscribed mentees
  ...
  const menteePaths = [
    {
      id: 1,
      pathName: "Mentor",
      path: "/mentee/view-mentors", // mentee can see other mentors
      icon: <PeopleOutlineOutlinedIcon fontSize="4xl" />,
    },
    {
      id: 2,
      pathName: "Mentee",
      path: "/mentee/view-mentees", // mentee can see other mentees
      icon: <PeopleOutlineOutlinedIcon fontSize="4xl" />,
    },
    {
      id: 3,
      pathName: "Sessions",
      path: "/mentee/view-sessions", // mentee can see all live and upcoming sessions
      icon: <ClassOutlinedIcon fontSize="4xl" />,
    },
    {
      id: 4,
      pathName: "Subscription",
      path: "/mentee/subscription", // mentor can see all subscribed mentees
      icon: <NotificationsActiveOutlinedIcon fontSize="4xl" />,
    },
    {
      id: 5,
